import type { ResTfulResultObject } from "../ResTfulResultObject"
 ...
 * @description Success
 */
export type ApiOrderOrdersForGridGetQueryResponse = ResTfulResultObject

export type ApiOrderOrdersForGridGetQueryParams = {
   /**
