 ...
 * @export
 */
export const AdjustmentsApiAxiosParamCreator = function (
   ...
   return {
       ...
       */
      apiAdjustmentsAdjustmentIdGet: async (
         id: number,
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiAdjustmentsAdjustmentIdGet.",
            )
         }
         const localVarPath = `/api/adjustments/adjustment/{id}`.replace(
            `{${"id"}}`,
       ...
       * @throws {RequiredError}
       */
      apiAdjustmentsAdjustmentPost: async (
       ...
       * @throws {RequiredError}
       */
      apiAdjustmentsAdjustmentsForGridGet: async (
       ...
       * @throws {RequiredError}
       */
      apiAdjustmentsAdjustmentsGet: async (
         pageNumber?: number,
         pageSize?: number,
         columnName?: string,
         columnValue?: string,
...
export const AdjustmentsApiFp = function (configuration?: Configuration) {
   return {
       ...
       * @throws {RequiredError}
       */
      async apiAdjustmentsAdjustmentIdGet(
         id: number,
         options?: AxiosRequestConfig,
      ): Promise<
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultAdjustmentDto>>
      > {
         const localVarAxiosArgs = await AdjustmentsApiAxiosParamCreator(
            configuration,
         ).apiAdjustmentsAdjustmentIdGet(id, options)
         return (
       ...
       * @throws {RequiredError}
       */
      async apiAdjustmentsAdjustmentPost(
         body?: CreateAdjustmentDto,
         options?: AxiosRequestConfig,
      ): Promise<
         (
      ...
      > {
         const localVarAxiosArgs = await AdjustmentsApiAxiosParamCreator(
            configuration,
         ).apiAdjustmentsAdjustmentPost(body, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
      ...
      > {
         const localVarAxiosArgs = await AdjustmentsApiAxiosParamCreator(
            configuration,
         ).apiAdjustmentsAdjustmentsForGridGet(
            requireTotalCount,
            requireGroupCount,
            isCountQuery,
            isSummaryQuery,
       ...
       * @throws {RequiredError}
       */
      async apiAdjustmentsAdjustmentsGet(
         pageNumber?: number,
         pageSize?: number,
         columnName?: string,
         columnValue?: string,
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultPaginatedResultAdjustmentDto>>
      > {
         const localVarAxiosArgs = await AdjustmentsApiAxiosParamCreator(
            configuration,
         ).apiAdjustmentsAdjustmentsGet(
            pageNumber,
            pageSize,
            columnName,
            columnValue,
 ...
 * @export
 */
export const AdjustmentsApiFactory = function (
   configuration?: Configuration,
   basePath?: string,
   axios?: AxiosInstance,
) {
...
export class AdjustmentsApi extends BaseAPI {
    ...
    */
   public async apiAdjustmentsAdjustmentIdGet(
      id: number,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultAdjustmentDto>> {
      return AdjustmentsApiFp(this.configuration)
         .apiAdjustmentsAdjustmentIdGet(id, options)
    ...
    * @memberof AdjustmentsApi
    */
   public async apiAdjustmentsAdjustmentPost(
      body?: CreateAdjustmentDto,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultAdjustmentDto>> {
      return AdjustmentsApiFp(this.configuration)
    ...
    * @memberof AdjustmentsApi
    */
   public async apiAdjustmentsAdjustmentsGet(
      pageNumber?: number,
      pageSize?: number,
      columnName?: string,
      columnValue?: string,
