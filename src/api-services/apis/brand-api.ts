...
export const BrandApiAxiosParamCreator = function (
   ...
   return {
       ...
       * @throws {RequiredError}
       */
      apiBrandDownloadBrandPdfUseridPost: async (
         userid: number,
         options: AxiosRequestConfig = {},
      ): Promise<RequestArgs> => {
         ...
         if (userid === null || userid === undefined) {
            throw new RequiredError(
               "userid",
               "Required parameter userid was null or undefined when calling apiBrandDownloadBrandPdfUseridPost.",
            )
         }
         const localVarPath = `/api/brand/download-brand-pdf/{userid}`.replace(
            `{${"userid"}}`,
...
export const BrandApiFp = function (configuration?: Configuration) {
   return {
       ...
       * @throws {RequiredError}
       */
      async apiBrandDownloadBrandPdfUseridPost(
         userid: number,
         options?: AxiosRequestConfig,
      ): Promise<
         (
      ...
      > {
         const localVarAxiosArgs = await BrandApiAxiosParamCreator(
            configuration,
         ).apiBrandDownloadBrandPdfUseridPost(userid, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
...
export class BrandApi extends BaseAPI {
    ...
    * @memberof BrandApi
    */
   public async apiBrandDownloadBrandPdfUseridPost(
      userid: number,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultIActionResult>> {
      return BrandApiFp(this.configuration)
