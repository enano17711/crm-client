...
export const ItemApiAxiosParamCreator = function (
   ...
   return {
       ...
       */
      apiItemItemBatchIdDelete: async (
         id: number,
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiItemItemBatchIdDelete.",
            )
         }
         const localVarPath = `/api/item/item-batch/{id}`.replace(
            `{${"id"}}`,
       ...
       * @throws {RequiredError}
       */
      apiItemItemBatchPost: async (
         body?: CreateItemBatchDto,
         options: AxiosRequestConfig = {},
      ): Promise<RequestArgs> => {
      ...
      apiItemItemByIdIdGet: async (
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiItemItemByIdIdGet.",
            )
         }
         const localVarPath = `/api/item/item-by-id/{id}`.replace(
            `{${"id"}}`,
            encodeURIComponent(String(id)),
         )
         // use dummy base URL string because the URL constructor only accepts absolute URLs.
      ...
      apiItemItemIdDelete: async (
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiItemItemIdDelete.",
            )
         }
         const localVarPath = `/api/item/item/{id}`.replace(
            `{${"id"}}`,
            encodeURIComponent(String(id)),
         )
         // use dummy base URL string because the URL constructor only accepts absolute URLs.
      ...
      apiItemItemIdPut: async (
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiItemItemIdPut.",
            )
         }
         const localVarPath = `/api/item/item/{id}`.replace(
            `{${"id"}}`,
...
export const ItemApiFp = function (configuration?: Configuration) {
   return {
       ...
       * @throws {RequiredError}
       */
      async apiItemItemBatchIdDelete(
         id: number,
         options?: AxiosRequestConfig,
      ): Promise<
         (
      ...
      > {
         const localVarAxiosArgs = await ItemApiAxiosParamCreator(
            configuration,
         ).apiItemItemBatchIdDelete(id, options)
         return (
      ...
      > {
         const localVarAxiosArgs = await ItemApiAxiosParamCreator(
            configuration,
         ).apiItemItemBatchPost(body, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
      ...
      async apiItemItemByIdIdGet(
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultItemSimpleDto>>
      > {
         const localVarAxiosArgs = await ItemApiAxiosParamCreator(
            configuration,
         ).apiItemItemByIdIdGet(id, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
      ...
      > {
         const localVarAxiosArgs = await ItemApiAxiosParamCreator(
            configuration,
         ).apiItemItemIdDelete(id, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
      ...
      > {
         const localVarAxiosArgs = await ItemApiAxiosParamCreator(
            configuration,
         ).apiItemItemIdPut(id, body, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
      ...
      async apiItemItemsGet(
         ...
         (
            ...
            AxiosResponse<RESTfulResultPaginatedResponseItemSimpleDto>
         >
      > {
         const localVarAxiosArgs = await ItemApiAxiosParamCreator(
            configuration,
...
export const ItemApiFactory = function (
   ...
   return {
      ...
      async apiItemItemBatchIdDelete(
         ...
         return ItemApiFp(configuration)
            .apiItemItemBatchIdDelete(id, options)
      ...
      async apiItemItemsGet(
         ...
         columnValue?: string,
         options?: AxiosRequestConfig,
      ): Promise<AxiosResponse<RESTfulResultPaginatedResponseItemSimpleDto>> {
         return ItemApiFp(configuration)
            .apiItemItemsGet(
               pageNumber,
               pageSize,
...
export class ItemApi extends BaseAPI {
    ...
    * @memberof ItemApi
    */
   public async apiItemItemBatchIdDelete(
      id: number,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<void>> {
    ...
    * @memberof ItemApi
    */
   public async apiItemItemBatchPost(
      body?: CreateItemBatchDto,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<void>> {
      return ItemApiFp(this.configuration)
    ...
    * @memberof ItemApi
    */
   public async apiItemItemByIdIdGet(
      id: number,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultItemSimpleDto>> {
      return ItemApiFp(this.configuration)
    ...
    * @memberof ItemApi
    */
   public async apiItemItemIdDelete(
      id: number,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<void>> {
      return ItemApiFp(this.configuration)
    ...
    * @memberof ItemApi
    */
   public async apiItemItemsForGridGet(
      requireTotalCount?: boolean,
      requireGroupCount?: boolean,
      isCountQuery?: boolean,
      isSummaryQuery?: boolean,
