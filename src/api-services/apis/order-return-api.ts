...
import { CreateOrderReturnDto } from '../models';
import { GroupingInfo } from '../models';
import { RESTfulResultLoadResult } from '../models';
import { RESTfulResultOrderReturnDto } from '../models';
import { RESTfulResultPaginatedResultOrderReturnDto } from '../models';
...
export const OrderReturnApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiOrderReturnOrderReturnIdGet: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling apiOrderReturnOrderReturnIdGet.');
            }
            const localVarPath = `/api/order-return/order-return/{id}`
        ...
        /**
         * 
         * @param {CreateOrderReturnDto} [body] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiOrderReturnOrderReturnPost: async (body?: CreateOrderReturnDto, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/order-return/order-return`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
export const OrderReturnApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiOrderReturnOrderReturnIdGet(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<RESTfulResultOrderReturnDto>>> {
            const localVarAxiosArgs = await OrderReturnApiAxiosParamCreator(configuration).apiOrderReturnOrderReturnIdGet(id, options);
         ...
         * @throws {RequiredError}
         */
        async apiOrderReturnOrderReturnPost(body?: CreateOrderReturnDto, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<RESTfulResultOrderReturnDto>>> {
            const localVarAxiosArgs = await OrderReturnApiAxiosParamCreator(configuration).apiOrderReturnOrderReturnPost(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async apiOrderReturnOrderReturnsForGridGet(requireTotalCount?: boolean, requireGroupCount?: boolean, isCountQuery?: boolean, isSummaryQuery?: boolean, skip?: number, take?: number, sort?: Array<SortingInfo>, group?: Array<GroupingInfo>, filter?: Array<any>, totalSummary?: Array<SummaryInfo>, groupSummary?: Array<SummaryInfo>, select?: Array<string>, preSelect?: Array<string>, remoteSelect?: boolean, remoteGrouping?: boolean, expandLinqSumType?: boolean, primaryKey?: Array<string>, defaultSort?: string, stringToLower?: boolean, paginateViaPrimaryKey?: boolean, sortByPrimaryKey?: boolean, allowAsyncOverSync?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<RESTfulResultLoadResult>>> {
            const localVarAxiosArgs = await OrderReturnApiAxiosParamCreator(configuration).apiOrderReturnOrderReturnsForGridGet(requireTotalCount, requireGroupCount, isCountQuery, isSummaryQuery, skip, take, sort, group, filter, totalSummary, groupSummary, select, preSelect, remoteSelect, remoteGrouping, expandLinqSumType, primaryKey, defaultSort, stringToLower, paginateViaPrimaryKey, sortByPrimaryKey, allowAsyncOverSync, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OrderReturnApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiOrderReturnOrderReturnIdGet(id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<RESTfulResultOrderReturnDto>> {
            return OrderReturnApiFp(configuration).apiOrderReturnOrderReturnIdGet(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {CreateOrderReturnDto} [body] 
         ...
         * @throws {RequiredError}
         */
        async apiOrderReturnOrderReturnPost(body?: CreateOrderReturnDto, options?: AxiosRequestConfig): Promise<AxiosResponse<RESTfulResultOrderReturnDto>> {
            return OrderReturnApiFp(configuration).apiOrderReturnOrderReturnPost(body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {boolean} [requireTotalCount] 
        ...
        async apiOrderReturnOrderReturnsForGridGet(requireTotalCount?: boolean, requireGroupCount?: boolean, isCountQuery?: boolean, isSummaryQuery?: boolean, skip?: number, take?: number, sort?: Array<SortingInfo>, group?: Array<GroupingInfo>, filter?: Array<any>, totalSummary?: Array<SummaryInfo>, groupSummary?: Array<SummaryInfo>, select?: Array<string>, preSelect?: Array<string>, remoteSelect?: boolean, remoteGrouping?: boolean, expandLinqSumType?: boolean, primaryKey?: Array<string>, defaultSort?: string, stringToLower?: boolean, paginateViaPrimaryKey?: boolean, sortByPrimaryKey?: boolean, allowAsyncOverSync?: boolean, options?: AxiosRequestConfig): Promise<AxiosResponse<RESTfulResultLoadResult>> {
            return OrderReturnApiFp(configuration).apiOrderReturnOrderReturnsForGridGet(requireTotalCount, requireGroupCount, isCountQuery, isSummaryQuery, skip, take, sort, group, filter, totalSummary, groupSummary, select, preSelect, remoteSelect, remoteGrouping, expandLinqSumType, primaryKey, defaultSort, stringToLower, paginateViaPrimaryKey, sortByPrimaryKey, allowAsyncOverSync, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} [pageNumber] 
...
export class OrderReturnApi extends BaseAPI {
     ...
     */
    public async apiOrderReturnOrderReturnIdGet(id: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<RESTfulResultOrderReturnDto>> {
        return OrderReturnApiFp(this.configuration).apiOrderReturnOrderReturnIdGet(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {CreateOrderReturnDto} [body] 
     ...
     * @memberof OrderReturnApi
     */
    public async apiOrderReturnOrderReturnPost(body?: CreateOrderReturnDto, options?: AxiosRequestConfig) : Promise<AxiosResponse<RESTfulResultOrderReturnDto>> {
        return OrderReturnApiFp(this.configuration).apiOrderReturnOrderReturnPost(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {boolean} [requireTotalCount] 
     ...
     * @memberof OrderReturnApi
     */
    public async apiOrderReturnOrderReturnsForGridGet(requireTotalCount?: boolean, requireGroupCount?: boolean, isCountQuery?: boolean, isSummaryQuery?: boolean, skip?: number, take?: number, sort?: Array<SortingInfo>, group?: Array<GroupingInfo>, filter?: Array<any>, totalSummary?: Array<SummaryInfo>, groupSummary?: Array<SummaryInfo>, select?: Array<string>, preSelect?: Array<string>, remoteSelect?: boolean, remoteGrouping?: boolean, expandLinqSumType?: boolean, primaryKey?: Array<string>, defaultSort?: string, stringToLower?: boolean, paginateViaPrimaryKey?: boolean, sortByPrimaryKey?: boolean, allowAsyncOverSync?: boolean, options?: AxiosRequestConfig) : Promise<AxiosResponse<RESTfulResultLoadResult>> {
        return OrderReturnApiFp(this.configuration).apiOrderReturnOrderReturnsForGridGet(requireTotalCount, requireGroupCount, isCountQuery, isSummaryQuery, skip, take, sort, group, filter, totalSummary, groupSummary, select, preSelect, remoteSelect, remoteGrouping, expandLinqSumType, primaryKey, defaultSort, stringToLower, paginateViaPrimaryKey, sortByPrimaryKey, allowAsyncOverSync, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {number} [pageNumber] 
