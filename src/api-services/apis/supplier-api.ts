 ...
 * @export
 */
export const SupplierApiAxiosParamCreator = function (
   ...
   return {
       ...
       */
      apiSupplierSupplierIdDelete: async (
         id: number,
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiSupplierSupplierIdDelete.",
            )
         }
         const localVarPath = `/api/supplier/supplier/{id}`.replace(
            `{${"id"}}`,
       ...
       * @throws {RequiredError}
       */
      apiSupplierSupplierIdGet: async (
         id: number,
         options: AxiosRequestConfig = {},
      ): Promise<RequestArgs> => {
         // verify required parameter 'id' is not null or undefined
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiSupplierSupplierIdGet.",
            )
         }
         const localVarPath = `/api/supplier/supplier/{id}`.replace(
            `{${"id"}}`,
       ...
       * @throws {RequiredError}
       */
      apiSupplierSupplierIdPut: async (
         id: number,
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiSupplierSupplierIdPut.",
            )
         }
         const localVarPath = `/api/supplier/supplier/{id}`.replace(
            `{${"id"}}`,
...
export const SupplierApiFp = function (configuration?: Configuration) {
   return {
       ...
       * @throws {RequiredError}
       */
      async apiSupplierSupplierIdDelete(
         id: number,
         options?: AxiosRequestConfig,
      ): Promise<
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultSupplierDto>>
      > {
         const localVarAxiosArgs = await SupplierApiAxiosParamCreator(
            configuration,
         ).apiSupplierSupplierIdDelete(id, options)
         return (
       ...
       * @throws {RequiredError}
       */
      async apiSupplierSupplierIdGet(
         id: number,
         options?: AxiosRequestConfig,
      ): Promise<
         (
      ...
      > {
         const localVarAxiosArgs = await SupplierApiAxiosParamCreator(
            configuration,
         ).apiSupplierSupplierIdGet(id, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
       ...
       * @throws {RequiredError}
       */
      async apiSupplierSupplierIdPut(
         id: number,
         body?: UpdateSupplierDto,
         options?: AxiosRequestConfig,
      ): Promise<
      ...
      > {
         const localVarAxiosArgs = await SupplierApiAxiosParamCreator(
            configuration,
         ).apiSupplierSupplierIdPut(id, body, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
      ...
      > {
         const localVarAxiosArgs = await SupplierApiAxiosParamCreator(
            configuration,
         ).apiSupplierSupplierPost(body, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
       ...
       * @throws {RequiredError}
       */
      async apiSupplierSuppliersForGridGet(
         requireTotalCount?: boolean,
         requireGroupCount?: boolean,
         isCountQuery?: boolean,
         isSummaryQuery?: boolean,
      ...
      > {
         const localVarAxiosArgs = await SupplierApiAxiosParamCreator(
            configuration,
         ).apiSupplierSuppliersForGridGet(
            requireTotalCount,
            requireGroupCount,
            isCountQuery,
            isSummaryQuery,
      ...
      async apiSupplierSuppliersGet(
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultPaginatedResultSupplierDto>>
      > {
         const localVarAxiosArgs = await SupplierApiAxiosParamCreator(
            configuration,
         ).apiSupplierSuppliersGet(
            pageNumber,
            pageSize,
            columnName,
            columnValue,
 ...
 * @export
 */
export const SupplierApiFactory = function (
   configuration?: Configuration,
   basePath?: string,
   axios?: AxiosInstance,
) {
   return {
      ...
      async apiSupplierSupplierIdDelete(
         ...
         return SupplierApiFp(configuration)
            .apiSupplierSupplierIdDelete(id, options)
...
export class SupplierApi extends BaseAPI {
    ...
    */
   public async apiSupplierSupplierIdDelete(
      id: number,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultSupplierDto>> {
      return SupplierApiFp(this.configuration)
         .apiSupplierSupplierIdDelete(id, options)
    ...
    * @memberof SupplierApi
    */
   public async apiSupplierSupplierIdGet(
      id: number,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultSupplierDto>> {
      return SupplierApiFp(this.configuration)
    ...
    * @memberof SupplierApi
    */
   public async apiSupplierSupplierIdPut(
      id: number,
      body?: UpdateSupplierDto,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultSupplierDto>> {
    ...
    * @memberof SupplierApi
    */
   public async apiSupplierSupplierPost(
      body?: CreateSupplierDto,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultSupplierDto>> {
      return SupplierApiFp(this.configuration)
    ...
    * @memberof SupplierApi
    */
   public async apiSupplierSuppliersForGridGet(
      requireTotalCount?: boolean,
      requireGroupCount?: boolean,
      isCountQuery?: boolean,
      isSummaryQuery?: boolean,
    ...
    * @memberof SupplierApi
    */
   public async apiSupplierSuppliersGet(
      pageNumber?: number,
      pageSize?: number,
      columnName?: string,
      columnValue?: string,
