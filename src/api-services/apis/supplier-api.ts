...
export const SupplierApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiSupplierSuppliersGet: async (pageNumber?: number, pageSize?: number, columnName?: string, columnValue?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SupplierApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSupplierSuppliersGet(pageNumber?: number, pageSize?: number, columnName?: string, columnValue?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<RESTfulResultPaginatedResultSupplierDto>>> {
            const localVarAxiosArgs = await SupplierApiAxiosParamCreator(configuration).apiSupplierSuppliersGet(pageNumber, pageSize, columnName, columnValue, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SupplierApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSupplierSuppliersGet(pageNumber?: number, pageSize?: number, columnName?: string, columnValue?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<RESTfulResultPaginatedResultSupplierDto>> {
            return SupplierApiFp(configuration).apiSupplierSuppliersGet(pageNumber, pageSize, columnName, columnValue, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SupplierApi extends BaseAPI {
     ...
     * @memberof SupplierApi
     */
    public async apiSupplierSuppliersGet(pageNumber?: number, pageSize?: number, columnName?: string, columnValue?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<RESTfulResultPaginatedResultSupplierDto>> {
        return SupplierApiFp(this.configuration).apiSupplierSuppliersGet(pageNumber, pageSize, columnName, columnValue, options).then((request) => request(this.axios, this.basePath));
    }
}
