...
export const SystemApiFp = function (configuration?: Configuration) {
   return {
       ...
       * @throws {RequiredError}
       */
      async apiSystemDescriptionGet(
         options?: AxiosRequestConfig,
      ): Promise<
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultString>>
      > {
         const localVarAxiosArgs = await SystemApiAxiosParamCreator(
            configuration,
         ).apiSystemDescriptionGet(options)
         return (
...
export class SystemApi extends BaseAPI {
    ...
    * @memberof SystemApi
    */
   public async apiSystemDescriptionGet(
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultString>> {
