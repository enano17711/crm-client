   ...
   return {
      ...
      apiTaxTaxIdDelete: async (
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiTaxTaxIdDelete.",
            )
         }
         const localVarPath = `/api/tax/tax/{id}`.replace(
            `{${"id"}}`,
      ...
      apiTaxTaxIdGet: async (
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiTaxTaxIdGet.",
            )
         }
         const localVarPath = `/api/tax/tax/{id}`.replace(
            `{${"id"}}`,
      ...
      apiTaxTaxIdPut: async (
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiTaxTaxIdPut.",
            )
         }
         const localVarPath = `/api/tax/tax/{id}`.replace(
            `{${"id"}}`,
   ...
   return {
      ...
      async apiTaxTaxIdDelete(
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultTaxDto>>
      > {
         const localVarAxiosArgs = await TaxApiAxiosParamCreator(
            configuration,
         ).apiTaxTaxIdDelete(id, options)
         return (
      ...
      > {
         const localVarAxiosArgs = await TaxApiAxiosParamCreator(
            configuration,
         ).apiTaxTaxIdPut(id, body, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
      ...
      async apiTaxTaxsGet(
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultPaginatedResultTaxDto>>
      > {
         const localVarAxiosArgs = await TaxApiAxiosParamCreator(
            configuration,
         ).apiTaxTaxsGet(pageNumber, pageSize, columnName, columnValue, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
...
export class TaxApi extends BaseAPI {
    ...
    * @memberof TaxApi
    */
   public async apiTaxTaxIdDelete(
      id: number,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultTaxDto>> {
    ...
    * @memberof TaxApi
    */
   public async apiTaxTaxsForGridGet(
      requireTotalCount?: boolean,
      requireGroupCount?: boolean,
      isCountQuery?: boolean,
      isSummaryQuery?: boolean,
