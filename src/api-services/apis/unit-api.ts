 ...
 * @export
 */
export const UnitApiAxiosParamCreator = function (
   ...
   return {
      ...
      apiUnitUnitIdDelete: async (
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiUnitUnitIdDelete.",
            )
         }
         const localVarPath = `/api/unit/unit/{id}`.replace(
            `{${"id"}}`,
      ...
      apiUnitUnitIdGet: async (
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiUnitUnitIdGet.",
            )
         }
         const localVarPath = `/api/unit/unit/{id}`.replace(
            `{${"id"}}`,
      ...
      apiUnitUnitIdPut: async (
         ...
         if (id === null || id === undefined) {
            throw new RequiredError(
               "id",
               "Required parameter id was null or undefined when calling apiUnitUnitIdPut.",
            )
         }
         const localVarPath = `/api/unit/unit/{id}`.replace(
            `{${"id"}}`,
   ...
   return {
      ...
      async apiUnitUnitIdDelete(
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultUnitDto>>
      > {
         const localVarAxiosArgs = await UnitApiAxiosParamCreator(
            configuration,
         ).apiUnitUnitIdDelete(id, options)
         return (
      ...
      > {
         const localVarAxiosArgs = await UnitApiAxiosParamCreator(
            configuration,
         ).apiUnitUnitIdPut(id, body, options)
         return (
            axios: AxiosInstance = globalAxios,
            basePath: string = BASE_PATH,
         ) => {
      ...
      async apiUnitUnitsGet(
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => Promise<AxiosResponse<RESTfulResultPaginatedResultUnitDto>>
      > {
         const localVarAxiosArgs = await UnitApiAxiosParamCreator(
            configuration,
         ).apiUnitUnitsGet(
 ...
 * @export
 */
export const UnitApiFactory = function (
   configuration?: Configuration,
   basePath?: string,
   axios?: AxiosInstance,
) {
   return {
      ...
      async apiUnitUnitIdDelete(
         ...
         return UnitApiFp(configuration)
            .apiUnitUnitIdDelete(id, options)
...
export class UnitApi extends BaseAPI {
    ...
    * @memberof UnitApi
    */
   public async apiUnitUnitIdDelete(
      id: number,
      options?: AxiosRequestConfig,
   ): Promise<AxiosResponse<RESTfulResultUnitDto>> {
      return UnitApiFp(this.configuration)
         .apiUnitUnitIdDelete(id, options)
    ...
    * @memberof UnitApi
    */
   public async apiUnitUnitsForGridGet(
      requireTotalCount?: boolean,
      requireGroupCount?: boolean,
      isCountQuery?: boolean,
      isSummaryQuery?: boolean,
