...
export const DataGridCustomerComponent = ({ dataSource }: DataGridProps) => {
   const { customersStore } = useAppStore()

   const openModalUpdate = (e: any) => {
      const customerRow = e.row.data as CustomerDto
      customersStore.actions.prepareForUpdate(customerRow)
   }

   const openModalDelete = (e: any) => {
      const customerRow = e.row.data as CustomerDto
      customersStore.actions.prepareForDelete(customerRow)
   }
