...
interface ModalEditeOrderItemQuantityComponentProps {
   refGrid: any
}

const ModalEditeOrderItemQuantityComponent = ({
   refGrid,
}: ModalEditeOrderItemQuantityComponentProps) => {
   const { ordersStore } = useAppStore()
   const { openUpdateModal, singleModel } = ordersStore.getters
   ...
   const onSubmit: SubmitHandler<IFormInputs> = (data) => {
      ordersStore.actions
         .updateItemOrder(singleModel.itemOrderId, data.quantity)
         .finally(() => {
...
export default ModalEditeOrderItemQuantityComponent
