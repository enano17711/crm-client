...
interface TotalSaleItemDetailsComponentProps {
   control: Control<IFormInputsForCreateSaleInterface, any>
}

const TotalSaleItemDetailsComponent = ({
   control,
}: TotalSaleItemDetailsComponentProps) => {
...
export default TotalSaleItemDetailsComponent
